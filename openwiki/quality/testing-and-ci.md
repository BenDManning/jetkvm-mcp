...
| Local session-release tool or ownership handoff | `internal/mcpserver/release_session_test.go`, `internal/jetkvm/release_session_test.go` | `go test ./internal/mcpserver ./internal/jetkvm -run 'Test(ReleaseSession|ManagerReleaseSession|DeviceOwnerReleaseSession)'` |
